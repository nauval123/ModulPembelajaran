...
class CustomCardWidget extends StatefulWidget {
  CustomCardWidget(this.judulcard, this.deskripsi, {Key? key})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        ...
        // status = prefs.getBool("guideStatus") ?? false;
        // print(widget.judulcard);
        // if (widget.judulcard == "AR & Bentuk 3D molekul") {
        //   if (status == false) {
        //     Navigator.push(
        //         context, MaterialPageRoute(builder: (context) => GuidePage()));
        //   } else {
        //     Navigator.of(context).pushNamed('/' + widget.judulcard);
        //   }
        // } else {
        Navigator.of(context).pushNamed('/' + widget.judulcard);
        // }
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        ...
                        image: AssetImage(
                            "assets/logo/icons/${widget.judulcard}.png"))),
              ),
            ],
          ),
        ),
