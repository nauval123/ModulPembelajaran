            ...
            children: [
              IconButton(
                  onPressed: () async {
                    ...
                    bool arCoreAvaibility =
                        await ArCoreController.checkArCoreAvailability();
                    if (arCoreInstalled == true && arCoreAvaibility == true) {
                      ...
                      AlertDialog alert = AlertDialog(
                        ...
                        content: Text(
                          "Aplikasi ARcore Belum terinstall / HP anda masih belum bisa untuk menggunakan fitur ini",
                          style: const TextStyle(color: Colors.black),
                        ),
                        actions: [
                          TextButton(
