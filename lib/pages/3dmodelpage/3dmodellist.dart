          ...
          if(snapshot.hasData){
            return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return index == 0 ?_searchBar() : _listmolecule(_listofmolecule, index-1,arstatus);
              },
            );
          }else {
                  ...
                  child: Card(
                    child: ListTile(
                      ...
                      trailing: Row(
                        ...
                        children: [
                          IconButton(onPressed: (){Navigator.of(context).pushNamed('/ar_flutter',arguments: listofmolecule[index]);}, icon: Icon(Icons.view_in_ar)),
